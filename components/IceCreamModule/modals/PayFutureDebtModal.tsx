...
import { X, CheckCircle2, Loader2, Calendar, Wallet } from 'lucide-react';
...
interface PayFutureDebtModalProps {
    ...
    form: { payment_date: string; payment_method: string };
            ...
            <div className="bg-white rounded-[40px] w-full max-w-md shadow-2xl overflow-hidden border-t-8 border-green-600 animate-in zoom-in duration-300">
                ...
                <div className="p-8 space-y-6">
                    ...
                    <div className="bg-green-50 p-5 rounded-2xl border border-green-100">
                        ...
                        <p className="text-[9px] font-black text-green-600 uppercase tracking-widest mb-1">Valor a Pagar</p>
                        <p className="text-2xl font-black text-green-700 italic">{formatCurrency(debtInfo.installment_amount)}</p>
                    </div>
                    ...
                    <button
                        onClick={onSubmit}
                        disabled={isSubmitting || !form.payment_date || !form.payment_method}
