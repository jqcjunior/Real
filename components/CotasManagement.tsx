  ...
  return (
    <div className="flex flex-col h-screen bg-[#f3f4f6] overflow-hidden text-blue-950 font-sans">
        ...
        <div className="bg-white px-4 py-3 flex flex-col lg:flex-row justify-between items-center gap-4 z-50 shadow-sm border-b shrink-0">
            ...
            <div className="flex flex-col sm:grid sm:grid-cols-3 lg:flex lg:flex-row gap-2 w-full lg:w-auto">
                <button onClick={() => { setSelectedStoresForOrder([viewStoreId]); setActiveForm('order'); }} className="w-full lg:w-auto bg-blue-900 text-white px-3 py-2 rounded-lg font-black uppercase text-[9px] shadow-sm hover:bg-black transition-all flex items-center justify-center gap-1.5 border-b-2 border-blue-950"><Plus size={12}/> Novo Pedido</button>
                <button onClick={() => setActiveForm('validated_orders')} className="w-full lg:w-auto bg-green-600 text-white px-3 py-2 rounded-lg font-black uppercase text-[9px] shadow-sm hover:bg-green-700 transition-all flex items-center justify-center gap-1.5 border-b-2 border-green-800"><BadgeCheck size={12}/> Validados</button>
                <button onClick={() => setActiveForm('mix_view')} className="w-full lg:w-auto bg-purple-600 text-white px-3 py-2 rounded-lg font-black uppercase text-[9px] shadow-sm hover:bg-purple-700 transition-all flex items-center justify-center gap-1.5 border-b-2 border-purple-800"><FileBarChart size={12}/> Mix</button>
                <button onClick={() => setActiveForm('expense')} className="w-full lg:w-auto bg-orange-600 text-white px-3 py-2 rounded-lg font-black uppercase text-[9px] shadow-sm hover:bg-orange-700 transition-all flex items-center justify-center gap-1.5 border-b-2 border-orange-800"><DollarSign size={12}/> Despesa</button>
                <button onClick={() => setActiveForm('cota_config')} className="w-full lg:w-auto bg-yellow-500 text-blue-950 px-3 py-2 rounded-lg font-black uppercase text-[9px] shadow-sm hover:bg-yellow-600 transition-all flex items-center justify-center gap-1.5 border-b-2 border-yellow-700"><Calculator size={12}/> Cota</button>
            </div>
        </div>
