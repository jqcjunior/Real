...
const App: React.FC = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            if(ics) setIceCreamSales(ics.map(x => ({...x, storeId: x.store_id, productName: x.product_name, unitsSold: x.units_sold, totalValue: x.total_value, paymentMethod: x.payment_method, sale_code: x.sale_code, buyer_name: x.buyer_name, createdAt: x.created_at})));
